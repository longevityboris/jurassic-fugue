...
%   13  F4. G8 A4. G8: the tune's cell-b rhythm, rising over the tenor's held entry note; A over C at 13:4 and the
%       tenor's F over C resolve together (6-5 and 4-3) into C at 13:4.5 (the skeleton's DIR 13:3 is gone).
%   14  the G is held over the lament's A-flat: 9-8 against the tenor's F (7-6 over the bass), then a stepwise
%       fall F E-flat D-flat C (half notes against the alto's CS2 eighths, contrary to its rise).
...
% Idiom: piano, the alto's re-struck C4 at 13:3 may be held by the pedal from 13:2.5 (upper staff C4-A5); the
%   soprano's G5 over the alto's F4-E4 at 14:1 is a ninth-tenth stretch for one eighth. Quartet: violin II from
%   A3 (13:1), as the blueprint states.
soprano = \absolute {
  % 13
  f''4. g''8 a''4. g''8~ | g''8 f''8 ees''2 des''4 | c''4. g''8~ g''8 f''8 ees''4 | f''2 ges''4 f''4 |
  % 17
  c''4. d''8 e''4 d''4 | c''4. des''8 des''4. f''8 | ges''4. f''8 f''4. ees''8 |
}
alto = \absolute {
  % 13
  a4. c'8 c'4 r4 | f'8 e'8 f'8 g'8 aes'8 g'8 bes'8 des'8 | aes'4 g'8 c''8~ c''2 | bes'8 c''8 bes'8 aes'8 ges'4 aes'4 |
  % 17
