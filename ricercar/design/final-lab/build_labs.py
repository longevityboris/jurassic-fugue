...
M = {
    ...
    'episodeCell': ("c''4. des''8 des''4. f''8 | ges''4. f''8 f''4. ees''8 | des''4 r2.",
                    "cell b = S1 bar 3 rhythm in sequence; soprano bar 18"),
    'descantEntryFour': ("f''2. r4 | r4 c''2 des''4 | c''2 r2 | r4 des''2 f''4 | e''2. d''4",
                         "free soprano over exposition entry 4 (c''-des''-c'' = the INV sigh at the answer level); bar 13"),
    'lamentLeadIn': ("bes2 a2 | aes2 g4 ges4", "tenor lead-in to its S1 entry over the pedal; bar 42"),
    'wedge': ("f''2. f''8 ges''8 | f''1 | f''1~ | f''2. ges''4~ | ges''2 g''2 | bes''2 bes''4 a''4 | bes''1",
              "soprano 44-50: INV head, inverted pedal, chromatic wedge to the V fermata (a'' at 49:4)"),
    'themeCantusFirmus': ("bes'2. bes'8 a'8 | bes'2. bes'8 a'8 | bes'4. c''8 c''4. ees''8 | ees''2. d''8 bes'8 | "
                          ...
                          "the whole theme untouched in B-flat major; its open c'' rises to d''; soprano bar 51"),
    'mirrorMajor': ("bes,2. bes,8 c8 | bes,2. bes,8 c8 | bes,4. a,8 a,4. f,8 | f,2. d,4",
                    "melodic mirror of S1 (major) about its first note; bass bar 51 (pickup g,-bes, replaced by d,4)"),
    'answerMajor': ("f,2. f,8 e,8 | f,2. f,8 e,8 | f,4. g,8 g,4. bes,8 | bes,2. a,8 f,8",
                    "the answer in F major under the tune's second half; bass bar 55"),
    'answerMirrorMajor': ("f2. f8 g8 | f2. f8 g8 | f4. e8 e4. c8 | c2. d8 f8",
                          "the answer's mirror = INV in major with e for ees over the F pedal; tenor bar 55"),
    'codaHead': ("bes2. bes8 a8 | bes1", "the subject's head as the last word (V7 over the tonic pedal); tenor bar 61"),
}
...
COPIES = [
    ...
    ('R2_P06_apotheosis_frame', '../proposal-4/lab/P06_apotheosis_frame.ly',
     'source of bars 51-60: proposal-4 P06 as written'),
]
...
def main():
    ...
    allrows += [('SK_final', 'THE WHOLE PIECE, bars 1-62')]
