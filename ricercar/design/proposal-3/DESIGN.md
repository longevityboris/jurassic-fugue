...
| 28-31 | E7 = S2 stretto | tenor ANS on f from 28.1; alto S2 from 28.3; soprano S2-F from 29.3 (one bar later, upper fifth; its last note g'' is held 32.3-33.3); **bass tacet 28.3-31** after S1's last note (three voices) | b-flat / f |
